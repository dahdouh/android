...
public class StudentAddActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
        ...
        save_btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
               ...
               if(selectedRadioButtonId == -1 || !validateLogin() || !validatePassword() || !validateFirstname() || !validateLastname()){
                   ...
                   //Toast.makeText(context, "PPPPPPPPPPPPPPPPPPPP"+sharedpreferences.getString(MainActivity.Password, null), Toast.LENGTH_LONG);

                   registeStudentRest(user_connected, login_data, password_data, firstname_data, lastname_data, parent_data, level_data);
    ...
    public void registeStudentRest(String user_connected, String login, String password, String firstName, String lastName, String parent, String level) {
        //String url = "https://onlineschool.cfapps.io/student/"+user_connected+"/"+ login+"/"+ password +"/"+ firstName +"/"+ lastName +"/"+ parent +"/"+ level;
        String url = "http://192.168.43.203:8085/student/"+user_connected+"/"+ login+"/"+ password +"/"+ firstName +"/"+ lastName +"/"+ parent +"/"+ level;
