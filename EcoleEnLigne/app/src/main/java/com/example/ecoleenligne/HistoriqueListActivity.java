...
import com.example.ecoleenligne.util.HistoriqueListAdapter;
...
public class HistoriqueListActivity extends AppCompatActivity implements Response.Listener<JSONArray>, Response.ErrorListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    private HistoriqueListAdapter studentListAdapter;
    ListView listview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton imadd = (ImageButton) findViewById(R.id.student_add_imageButton);
        imadd.setImageBitmap(null);

        CircleImageView circleImageView1 = (CircleImageView) findViewById(R.id.user_photo);
        circleImageView1.setImageResource(R.drawable.histo);
        ...
        /*------------------------ List of students  ---------------------*/
        this.studentListAdapter = new HistoriqueListAdapter(this, students);
        ...
        url =  MainActivity.IP+"/api/log/"+ id_user;
    ...
    public void onResponse(JSONArray response) {
        try {
            ...
            for (int i = 0; i < response.length(); i++) {
                ...
                String activity = item.getString("libelle");
                String date = item.getString("dateActivity");
                SimpleDateFormat formatter = new SimpleDateFormat("dd-MM-yyyy");
                Date date1 = formatter.parse(date);
                String datef = date1.toString();
                datef = datef.substring(0,10);
                students.add(new User(Integer.parseInt(id), activity, datef, ""));
    ...
    protected void onResume() {
        ...
        String url =  MainActivity.IP+"/api/log/"+ id_user;
        ...
        if(user_connected_id == null && user_connected_login == null) {
            ...
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    Intent intent=new Intent(HistoriqueListActivity.this, LoginActivity.class);
