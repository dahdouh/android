...
public class ChoixCourorExoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgpdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(ChoixCourorExoActivity.this, PdfCourseActivity.class);
        ...
        imgvideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1 = new Intent(ChoixCourorExoActivity.this, ListeExercicesActivity.class);
                intent1.putExtra("id",id);
                startActivity(intent1);
